...
{ // Don't edit above this line
    partial class Parts
    {	
		private AnimationDef KJN_KWP_BMB_an_m65A1_1000lb_Animation => new AnimationDef
        {
            ...
            //                       //Valid options include Reloading, Firing, Tracking, Overheated, TurnOn, TurnOff, BurstReload, NoMagsToLoad, PreFire, EmptyOnGameLoad, StopFiring, StopTracking, LockDelay, Init, Homing, TargetAligned, WhileOn, TargetRanged100, TargetRanged75, TargetRanged50, TargetRanged25
            //           new EventParticle
            //           {
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("bomb_ammo_1000"),
                    ...
                    EventMoveSets = new Dictionary<PartAnimationSetDef.EventTriggers, RelMove[]>
                    {
                        ...
                        // Event Options
                        // --------------
                        // Reloading, Firing, Tracking, Overheated, TurnOn, TurnOff, 
                        // BurstReload, NoMagsToLoad, PreFire, EmptyOnGameLoad, StopFiring, 
                        // StopTracking, LockDelay, Init, Homing, TargetAligned, WhileOn, 
                        // TargetRanged100, TargetRanged75, TargetRanged50, TargetRanged25
