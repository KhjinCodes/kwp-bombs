...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition KJN_KWP_BMB_an_m66A1_2000lb_Weapon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {

                    // NOTE: For any ID text related to subparts, remove the "Subpart_" part.
                    new MountPointDef {
                        SubtypeId = "KJN_KWP_BMB_an_m66A1_2000lb_block", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_missile_1000", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "AN-M66A1 2000 lb Bomb G.P. Bomb Mount", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.636f, // Inventory capacity in kL.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "WepShipGatlingNoAmmo", // Audio for firing.
            ...
            Ammos = new[] {
                KJN_KWP_BMB_an_m66A1_2000lb_Ammo, 
                KJN_KWP_BMB_Shrapnel_Ammo, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = KJN_KWP_BMB_an_m66A1_2000lb_Animation,
