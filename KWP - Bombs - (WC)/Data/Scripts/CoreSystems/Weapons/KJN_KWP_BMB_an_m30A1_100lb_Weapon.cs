...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition KJN_KWP_BMB_an_m30A1_100lb_Weapon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    ...
                    new MountPointDef {
                        SubtypeId = "KJN_KWP_BMB_an_m30A1_100lb_block", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_missile_100", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "AN-M30A1 100 lb G.P. Bomb Mount", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.025f, // Inventory capacity in kL.
            ...
            Ammos = new[] {
                KJN_KWP_BMB_an_m30A1_100lb_Ammo, 
                KJN_KWP_BMB_Shrapnel_Ammo, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = KJN_KWP_BMB_an_m30A1_100lb_Animation,
