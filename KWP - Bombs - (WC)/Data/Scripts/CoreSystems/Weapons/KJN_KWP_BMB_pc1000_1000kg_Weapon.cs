...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition KJN_KWP_BMB_pc1000_1000kg_Weapon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    ...
                    new MountPointDef {
                        SubtypeId = "KJN_KWP_BMB_pc1000_1000kg_block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "PC1000 1000 kg A.P. Bomb Mount", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.395f, // Inventory capacity in kL.
