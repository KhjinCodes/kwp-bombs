...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition KJN_KWP_BMB_an_m65A1_1000lb_Weapon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    ...
                    new MountPointDef {
                        SubtypeId = "KJN_KWP_BMB_an_m65A1_1000lb_block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "AN-M65A1 1000 lb Bomb G.P. Bomb Mount", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.290f, // Inventory capacity in kL.
            ...
            Ammos = new[] {
                KJN_KWP_BMB_an_m65A1_1000lb_Ammo, 
                KJN_KWP_BMB_Shrapnel_Ammo, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = KJN_KWP_BMB_an_m65A1_1000lb_Animation,
