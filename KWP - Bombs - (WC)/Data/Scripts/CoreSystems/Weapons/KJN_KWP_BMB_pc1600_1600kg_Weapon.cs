...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition KJN_KWP_BMB_pc1600_1600kg_Weapon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    ...
                    new MountPointDef {
                        SubtypeId = "KJN_KWP_BMB_pc1600_1600kg_block", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_missile_1600", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            {
                PartName = "PC1600 1600 kg A.P. Bomb Mount", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.631f, // Inventory capacity in kL.
            ...
            Ammos = new[] {
                KJN_KWP_BMB_pc1600_1600kg_Ammo,
                KJN_KWP_BMB_PenShrapnel_Ammo, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = KJN_KWP_BMB_pc1600_1600kg_Animation,
